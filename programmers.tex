...
%% vlozit ukazku vety, ktera zacina potvrzeným \mbox{n-gramem}.
...
Abychom udělali počítání zlepšujících resp. zhoršujících \mbox{n-gramů} co nejefektivnější,
...
%% vložit obrázky s porovnáváním vět a zvýrazněnými potvrzenými, zlepšujícími nebo zhoršujícími \mbox{n-gramy}
...
%% vlozit obrázek s výpisem nejvíce zlepšujících / zhoršujících \mbox{n-gramů}
...
Jelikož se daný \mbox{n-gram} může nacházet v mnoha větách,
...
%% vlozit obrazek zhorsujiciho \mbox{n-gramu}, ktery obsahuje zlepsujici \mbox{n-gram}
