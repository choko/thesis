...
Ve všech obrázcích budou potvrzené \mbox{n-gramy} zvýrazněny červenou barvou (to je možné vidět na Obrázku \ref{img:graph-2}).
...
Těžší situace nastane,
  když je kandidátů na potvzený \mbox{n-gram} více než výskytů daného \mbox{n-gramů} v referenci.
...
\begin{figure}[h!]
	...
	\caption{
		Ukázka grafu s referencí a překladem, ve kterém se nachází více kandidátů pro \mbox{n-gram} \uv{Jájo,}. \\
		\textbf{Reference}: Jájo, já mám hlad. \\
...
Všichni kandidáti, kteří se nacházejí na této cestě,
  vždy patří mezi potvrzené \mbox{n-gramy}.
...
\begin{figure}[h!]
	...
	\caption{Ukázka grafu s referencí a překladem, ve kterém se nachází více kandidátů pro \mbox{n-gram} \uv{Jájo,}.
